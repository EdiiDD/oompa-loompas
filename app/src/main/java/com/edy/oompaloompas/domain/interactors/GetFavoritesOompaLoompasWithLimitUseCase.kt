...
class GetFavoritesOompaLoompasWithLimitUseCase @Inject constructor(
    private val oompaLoompaRepository: OompaLoompaRepository,
    dispatcherProvider: DispatcherProvider,
) : FlowUseCase<Unit, Resource<OompaLoompas>>(dispatcherProvider) {

    override fun start(param: Unit): Flow<Resource<OompaLoompas>> = oompaLoompaRepository.getFavoritesOompaLoopmaWithLimit()
}